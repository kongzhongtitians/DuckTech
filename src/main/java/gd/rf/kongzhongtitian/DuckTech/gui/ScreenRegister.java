package gd.rf.kongzhongtitian.DuckTech.gui;

import gd.rf.kongzhongtitian.DuckTech.DuckTech;
import gd.rf.kongzhongtitian.DuckTech.gui.advance_shredder.AdvanceShredderScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.air_purifier.AirPurifierScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.essence_blast_furnace.EssenceBlastFurnaceScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.essence_conversion_machine.EssenceConversionMachineScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.essence_earth_furnace.EssenceEarthFurnaceScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.essence_furnace.EssenceFurnaceScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.expulsion_machine.ExpulsionMachineScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.fe2thermal_essence_machine.FE2ThermalEssenceMachineScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.frozen_essence_maker.FrozenEssenceMakerScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.injection_machine.InjectionMachineScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.juice_extractor.JuiceExtractorScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.levitation.LevitationMachineScreen;
import gd.rf.kongzhongtitian.DuckTech.gui.thermal_essence_maker.ThermalEssenceMakerScreen;
